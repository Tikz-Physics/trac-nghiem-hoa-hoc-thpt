...
<head>
  ...
  <title>Hệ Thống Trắc Nghiệm Hoá Học 10</title>
...
<body>
      ...
      <div class="header-bar">
        ...
        <div class="header-group">
          ...
          <select class="lesson-select" id="lessonDropdown" onchange="changeLesson(this.value)">
            <optgroup label="CHƯƠNG 1: CẤU TẠO NGUYÊN TỬ">
              <option value="1">Bài 1: Thành phần của nguyên tử</option>
              <option value="2">Bài 2: Nguyên tố hóa học</option>
              <option value="3">Bài 3: Cấu trúc lớp vỏ electron nguyên tử</option>
              <option value="4">Bài 4: Ôn tập chương 1 (Cấu tạo nguyên tử)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 2: BẢNG TUẦN HOÀN & ĐỊNH LUẬT TUẦN HOÀN">
              <option value="5">Bài 5: Cấu tạo của bảng tuần hoàn các nguyên tố hóa học</option>
              <option value="6">Bài 6: Xu hướng biến đổi tính chất trong bảng tuần hoàn</option>
              <option value="7">Bài 7: Định luật tuần hoàn và ý nghĩa bảng tuần hoàn</option>
              <option value="8">Bài 8: Ôn tập chương 2 (Bảng tuần hoàn)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 3: LIÊN KẾT HÓA HỌC">
              <option value="9">Bài 9: Quy tắc octet</option>
              <option value="10">Bài 10: Liên kết ion</option>
              <option value="11">Bài 11: Liên kết cộng hóa trị</option>
              <option value="12">Bài 12: Liên kết hydrogen và tương tác van der Waals</option>
              <option value="13">Bài 13: Ôn tập chương 3 (Liên kết hóa học)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 4: PHẢN ỨNG OXI HÓA – KHỬ">
              <option value="14">Bài 14: Phản ứng oxi hóa – khử</option>
              <option value="15">Bài 15: Phản ứng oxi hóa – khử trong thực tiễn</option>
              <option value="16">Bài 16: Ôn tập chương 4 (Phản ứng oxi hóa – khử)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 5: NĂNG LƯỢNG HÓA HỌC">
              <option value="17">Bài 17: Biến thiên enthalpy trong các phản ứng hóa học</option>
              <option value="18">Bài 18: Ôn tập chương 5 (Năng lượng hóa học)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 6: TỐC ĐỘ PHẢN ỨNG HÓA HỌC">
              <option value="19">Bài 19: Tốc độ phản ứng hóa học</option>
              <option value="20">Bài 20: Các yếu tố ảnh hưởng đến tốc độ phản ứng</option>
              <option value="21">Bài 21: Ôn tập chương 6 (Tốc độ phản ứng)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 7: NGUYÊN TỐ NHÓM HALOGEN">
              <option value="22">Bài 22: Khái quát về nhóm halogen</option>
              <option value="23">Bài 23: Hydrogen halide và một số hợp chất của halogen</option>
            </optgroup>
          </select>
  ...
  <script>
    ...
    function showResults() {
      ...
      try {
        const key = 'HOA10_LESSON_SCORE_' + currentLessonId;
    ...
    function renderDashboard() {
      ...
      chapters.forEach(ch => {
        ...
        for (let id = ch.start; id <= ch.end; id++) {
          ...
          const scoreStr = SafeStorage.getItem('HOA10_LESSON_SCORE_' + id);
      ...
      document.getElementById('dashCompletedCount').textContent = completedCount + ' / 23';
    ...
    function resetProgress() {
      if (confirm('Em có chắc chắn muốn xóa tất cả lịch sử điểm số của 23 bài học để làm lại từ đầu không?')) {
        for (let i = 1; i <= 23; i++) {
          SafeStorage.removeItem('HOA10_LESSON_SCORE_' + i);
        }
        renderDashboard();
...
<head>
  ...
  <meta name="mobile-web-app-capable" content="yes" />
  <meta name="theme-color" content="#070a14" />
  <title>Hoá Học 10 - ${lessonTitle}</title>
  <link rel="manifest" href="./manifest.json" />
  <link rel="apple-touch-icon" href="./icon-192.png" />
  <link rel="icon" type="image/png" sizes="192x192" href="./icon-192.png" />
  <link rel="icon" type="image/png" sizes="512x512" href="./icon-512.png" />
...
<body>
  ...
  <div class="container">
    <header>
      <div class="header-bar">
        ...
        <div class="header-group">
          <a href="./index.html" class="nav-btn-hub">← Hub Lớp 10</a>
          <div class="teacher-badge" id="teacherBadge" onclick="openTeacherModal()" title="Nhấp để thay đổi tên giáo viên">
            <span>👨‍🏫</span>
            <span id="teacherNameDisplay">Thầy Cô</span>
            <span class="btn-edit-pen">✏️</span>
  ...
  <script>
    ...
    function showResults() {
      ...
      try {
        const key = 'HOA10_LESSON_SCORE_' + LESSON_ID;
        const oldScore = parseFloat(SafeStorage.getItem(key) || '0');
        if (totalPoints > oldScore) {
          SafeStorage.setItem(key, totalPoints.toFixed(2));
        }
