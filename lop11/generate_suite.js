...
<head>
  ...
  <title>Hệ Thống Trắc Nghiệm Hoá Học 11</title>
      ...
      <div class="header-bar">
        ...
        <div class="header-group">
          ...
          <select class="lesson-select" id="lessonDropdown" onchange="changeLesson(this.value)">
            <optgroup label="CHƯƠNG 1: CÂN BẰNG HÓA HỌC">
              <option value="1">Bài 1: Khái niệm về cân bằng hóa học</option>
              <option value="2">Bài 2: Cân bằng trong dung dịch nước</option>
              <option value="3">Bài 3: Ôn tập chương 1 (Cân bằng hóa học)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 2: NITROGEN – SULFUR">
              <option value="4">Bài 4: Nitrogen</option>
              <option value="5">Bài 5: Ammonia và muối ammonium</option>
              <option value="6">Bài 6: Một số hợp chất của nitrogen với oxygen</option>
              <option value="7">Bài 7: Sulfur và sulfur dioxide</option>
              <option value="8">Bài 8: Sulfuric acid và muối sulfate</option>
              <option value="9">Bài 9: Ôn tập chương 2 (Nitrogen – Sulfur)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 3: ĐẠI CƯƠNG HÓA HỌC HỮU CƠ">
              <option value="10">Bài 10: Hợp chất hữu cơ và hóa học hữu cơ</option>
              <option value="11">Bài 11: Phương pháp tách biệt và tinh chế hợp chất hữu cơ</option>
              <option value="12">Bài 12: Công thức phân tử hợp chất hữu cơ</option>
              <option value="13">Bài 13: Cấu tạo hóa học hợp chất hữu cơ</option>
              <option value="14">Bài 14: Ôn tập chương 3 (Đại cương hóa học hữu cơ)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 4: HYDROCARBON">
              <option value="15">Bài 15: Alkane</option>
              <option value="16">Bài 16: Hydrocarbon không no (Alkene – Alkyne)</option>
              <option value="17">Bài 17: Arene (Hydrocarbon thơm)</option>
              <option value="18">Bài 18: Ôn tập chương 4 (Hydrocarbon)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 5: DẪN XUẤT HALOGEN – ALCOHOL – PHENOL">
              <option value="19">Bài 19: Dẫn xuất halogen</option>
              <option value="20">Bài 20: Alcohol</option>
              <option value="21">Bài 21: Phenol</option>
              <option value="22">Bài 22: Ôn tập chương 5 (Dẫn xuất halogen – Alcohol – Phenol)</option>
            </optgroup>
            <optgroup label="CHƯƠNG 6: HỢP CHẤT CARBONYL – CARBOXYLIC ACID">
              <option value="23">Bài 23: Hợp chất carbonyl (Aldehyde – Ketone)</option>
              <option value="24">Bài 24: Carboxylic acid</option>
              <option value="25">Bài 25: Ôn tập chương 6 (Hợp chất carbonyl – Carboxylic acid)</option>
            </optgroup>
          </select>
  ...
  <div class="dashboard-modal" id="dashboardModal" style="display:none;" onclick="if(event.target===this) toggleDashboard()">
    <div class="dashboard-content" onclick="event.stopPropagation()">
      <div class="dashboard-header">
        <h2>📊 HỌC BẠ TIẾN ĐỘ HOÁ HỌC 11 - 6 CHƯƠNG</h2>
  ...
  <script>
    ...
    function goToNextLesson() {
      if (currentLessonId < 25) {
        ...
        alert('Chúc mừng em đã hoàn thành tất cả 25 bài học của toàn bộ 6 Chương Hoá Học 11!');
      }
    }
    ...
    function showResults() {
      ...
      try {
        const key = 'HOA11_LESSON_SCORE_' + currentLessonId;
      ...
      if (totalPoints >= 9.0) {
        ...
        cmt.textContent = teacherName + ' biểu dương em! Em đã làm chủ hoàn hảo bài học Hoá Học 11 với tư duy sắc bén và năng lực hoá học vượt trội!';
    ...
    function renderDashboard() {
      ...
      chapters.forEach(ch => {
        ...
        for (let id = ch.start; id <= ch.end; id++) {
          ...
          const scoreStr = SafeStorage.getItem('HOA11_LESSON_SCORE_' + id);
    ...
    function resetProgress() {
      if (confirm('Em có chắc chắn muốn xóa tất cả lịch sử điểm số của 25 bài học để làm lại từ đầu không?')) {
        for (let i = 1; i <= 25; i++) {
          SafeStorage.removeItem('HOA11_LESSON_SCORE_' + i);
        }
        renderDashboard();
...
`;
  ...
  fs.writeFileSync('index.html', html, 'utf8');
  console.log('Successfully generated upgraded Master Hub (index.html & index.html)!');
}
...
<head>
  ...
  <meta name="mobile-web-app-capable" content="yes" />
  <meta name="theme-color" content="#070a14" />
  <title>Hoá Học 11 - ${lessonTitle}</title>
  <link rel="manifest" href="./manifest.json" />
  <link rel="apple-touch-icon" href="./icon-192.png" />
  <link rel="icon" type="image/png" sizes="192x192" href="./icon-192.png" />
  <link rel="icon" type="image/png" sizes="512x512" href="./icon-512.png" />
...
<body>
  ...
  <div class="container">
    <header>
      <div class="header-bar">
        ...
        <div class="header-group">
          <a href="./index.html" class="nav-btn-hub">← Hub Lớp 11</a>
          <div class="teacher-badge" id="teacherBadge" onclick="openTeacherModal()" title="Nhấp để thay đổi tên giáo viên">
            <span>👨‍🏫</span>
            <span id="teacherNameDisplay">Thầy Cô</span>
            <span class="btn-edit-pen">✏️</span>
          ...
          <div class="lesson-title-badge">HOÁ HỌC 11 – ${lessonTitle}</div>
        </div>
    ...
    <div class="result-card" id="resultCard">
      ...
      <div style="display: flex; justify-content: center; gap: 10px; flex-wrap: wrap;">
        <button class="btn-action" onclick="restartLesson()">Làm lại bài này ⟲</button>
        <a href="./index.html" class="btn-action btn-next-step" style="text-decoration:none;">Về Cổng Tổng Hợp ➔</a>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function showResults() {
      ...
      try {
        const key = 'HOA11_LESSON_SCORE_' + LESSON_ID;
        const oldScore = parseFloat(SafeStorage.getItem(key) || '0');
        if (totalPoints > oldScore) {
          SafeStorage.setItem(key, totalPoints.toFixed(2));
        }
